...
## Decisions
Architectural decisions are recorded as ADRs under `spec/adr/` (ADR-001 … ADR-008). The load-bearing
ones: identity namespace root (001), grant authorization (004), external anchoring (005), evidence
not enforcement (006), and the signing curve (008).
